...
function generateForm(userData) {
  ...
  doc.fontSize(12);
  doc.font('Helvetica-Bold').text(inputFormat( 12, dateFormat(userData.start_date)+ '  ' + dateFormat(userData.finish_date)),
  ...
  doc.fontSize(12);
  doc.font('Helvetica-Bold').text( userData.intership,
  ...
  doc.fontSize(12);
  doc.font('Helvetica-Bold').text( userData.tesis,
